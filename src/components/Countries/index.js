...
import ImageName from '../ImageItems'
...
class Countries extends Component {
  ...
  onChangeVisit = id => {
    ...
    const productObject = countriesList.find(
      eachCartItem => eachCartItem.id === id,
    )
    if (productObject) {
      this.setState(prevState => ({
        countriesList: prevState.countriesList.map(eachCartItem => {
          if (productObject.id === eachCartItem.id) {
            return {...eachCartItem, isVisited: true}
          }
  ...
  onRemoveItem = id => {
    ...
    if (productObject) {
      this.setState(prevState => ({
        countriesList: prevState.countriesList.map(eachCartItem => {
          if (productObject.id === eachCartItem.id) {
            return {...eachCartItem, isVisited: false}
          }
